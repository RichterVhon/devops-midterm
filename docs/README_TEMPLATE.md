...
* **Ink Edge Validation (Milestone 2)**: Visual proof of the strict binary mask (0/255) verified by `validate_ink_edges`.
  ![Edge_Mask_Proof](./docs/screenshots/mask_test1.png.jpg)
  ![Edge_Mask_Proof2](./docs/screenshots/mask_test_saige.png.jpg)

* **Paint Effect (Milestone 2)**: Visual confirmation of the K-Means color quantization and Bilateral smoothing.
