...
> **Documenter Source:** _Project Board "Done" Column + Merged Pull Requests._
...
_This maps your current directory to the container to see results locally._
...
Lead Developer: franco | Implementation Paths: src/processor.py, src/watcher.py, src/filters/edges.py, src/filters/colors.py
The core engine utilizes **OpenCV (cv2)** following this logic:

1. **Ingestion**: Scans the /input directory using watchdog (PollingObserver) in watcher.py for valid file signatures (.jpg, .png, .jpeg). The system validates file integrity using retry logic before triggering process_single_image().

2. **Transformation**:
   - **Grayscale**: Converts BGR images into single-channel luminosity to simplify intensity-based analysis.
   - **Edge Detection**: Uses Adaptive Thresholding to generate a strict binary edge mask for object boundary extraction.
   - **Color Quantization**: Implements K-Means Clustering (k=8) to reduce the image into dominant color regions.
   - **Smoothing**: Applies Bilateral Filtering to preserve edges while producing a painted/cartoon effect.
   - **Mask Integration**: Combines the edge mask with the stylized image using cv2.bitwise_and().
3. - **Export**: Saves processed outputs into structured directories under /output, including /paint, /processed, and /. debug*masks, using standardized filename prefixes (paint*, processed*, mask*) to ensure traceability and debugging transparency.

### 🧪 Quality Assurance (Automated Testing)
**Testing:** Ralph (saige) | **Test Directory** [`tests/`](tests/)

> **Documenter Source:** _PyTest terminal logs and GitHub Actions history_
...
> **Documenter Source:** _Tester's PR screenshots and Local File System logs_
...
|-------------------------------------------------------|---------------------------------------------------------------------------------|---------------------------------------------------------|---------------------------------------------------|--------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-------------|
| Milestone 1: Setup & Architecture (The Foundation)    | [Docs] Centralized Documentation Hub & README Evolution                         | https://github.com/RichterVhon/devops-midterm/issues/5  | jugs301, RalphLesterQReyes, RichterVhon, xelarkkk | Done   | https://github.com/RichterVhon/devops-midterm/pull/28, https://github.com/RichterVhon/devops-midterm/pull/33, https://github.com/RichterVhon/devops-midterm/pull/50, https://github.com/RichterVhon/devops-midterm/pull/53, https://github.com/RichterVhon/devops-midterm/pull/55, https://github.com/RichterVhon/devops-midterm/pull/57, https://github.com/RichterVhon/devops-midterm/pull/59, https://github.com/RichterVhon/devops-midterm/pull/61, https://github.com/RichterVhon/devops-midterm/pull/62, https://github.com/RichterVhon/devops-midterm/pull/67 |             |             |
| Milestone 1: Setup & Architecture (The Foundation)    | [Logic] Implement watchdog Observer for Event-Driven Processing                 | https://github.com/RichterVhon/devops-midterm/issues/47 | jugs301                                           | Done   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |             |             |
| Milestone 1: Setup & Architecture (The Foundation)    | [Logic] Mandatory Verbose Logging for Watchdog Service                          | https://github.com/RichterVhon/devops-midterm/issues/51 | jugs301                                           | Done   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |             |             |
| Milestone 1: Setup & Architecture (The Foundation)    | [DevOps] Container Persistence and Volume Strategy for Hot-Folder Logic         | https://github.com/RichterVhon/devops-midterm/issues/48 | RichterVhon                                       | Done   | https://github.com/RichterVhon/devops-midterm/pull/52                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |             |             |
...
| Milestone 1: Setup & Architecture (The Foundation)    | [DevOps] Environment Containerization                                           | https://github.com/RichterVhon/devops-midterm/issues/3  | RichterVhon                                       | Done   | https://github.com/RichterVhon/devops-midterm/pull/23                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Feb 3, 2026 | Feb 3, 2026 |
...
| Milestone 1: Setup & Architecture (The Foundation)    | Update docs - quantization assurance part                                       | https://github.com/RichterVhon/devops-midterm/issues/72 |                                                   | Done   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |             |             |
...
| Milestone 3: Feature - The Paint (Color & Smoothing)  | [Test] Verify Color Count Reduction                                             | https://github.com/RichterVhon/devops-midterm/issues/26 | RalphLesterQReyes                                 | Done   | https://github.com/RichterVhon/devops-midterm/pull/46                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |             |             |
...
| Milestone 4: Feature - The Fusion (Final Integration) | [DevOps]  Implement Polling-Based Watcher for Cross-Platform Volume Consistency | https://github.com/RichterVhon/devops-midterm/issues/64 | RichterVhon                                       | Done   | https://github.com/RichterVhon/devops-midterm/pull/52, https://github.com/RichterVhon/devops-midterm/pull/60, https://github.com/RichterVhon/devops-midterm/pull/63                                                                                                                                                                                                                                                                                                                                                                                                  |             |             |
